...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 767012176556667597, ; hash 0xaa4f982c20f32cd, from name: aot-UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3020224706380099115, ; hash 0x29e9fe5e5da4ee2b, from name: libaot-UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	...
	%struct.DSOCacheEntry {
		i64 5491585212791539467, ; hash 0x4c3607a7c63a470b, from name: UploadFotos.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 132
	...
	%struct.DSOCacheEntry {
		i64 5956034453952851045, ; hash 0x52a815c789d8ec65, from name: aot-UploadFotos.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	...
	%struct.DSOCacheEntry {
		i64 6887273539715670267, ; hash 0x5f9482cb45b320fb, from name: UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 12950016016907990934, ; hash 0xb3b7b2f48b6b7796, from name: libaot-UploadFotos.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 334
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0e790dc9-4f77-4067-abef-13588350a133\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.uploadfotos\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-UploadFotos.dll.so\00", align 16
