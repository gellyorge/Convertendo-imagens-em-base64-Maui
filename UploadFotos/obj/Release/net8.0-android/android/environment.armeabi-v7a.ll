...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 784653151, ; hash 0x2ec4db5f, from name: aot-UploadFotos.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1943505275, ; hash 0x73d7897b, from name: UploadFotos.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 2354057276, ; hash 0x8c50103c, from name: libaot-UploadFotos.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 3184277696, ; hash 0xbdcc38c0, from name: libaot-UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 3431139293, ; hash 0xcc8307dd, from name: aot-UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
	...
	%struct.DSOCacheEntry {
		i64 4294561591, ; hash 0xfff9cf37, from name: UploadFotos
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-UploadFotos.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
